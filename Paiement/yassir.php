...
<head>
    ...
    <title>Paiement Yassir | HFC</title>
    ...
    <style>
        :root {
            --primary-color: #ffdd00; /* Jaune Yassir */
            --secondary-color: #e6c800;
            --dark-color: #1a1a1a;
            --light-bg: #f8f9fa;
        }
...
<body>
    ...
    <div class="payment-container">
        <div class="payment-header">
            <h1 class="payment-title"><i class="fas fa-taxi me-2"></i>Paiement par Yassir</h1>
            <div class="reservation-id">Réservation #<?= htmlspecialchars($reservation['id']) ?></div>
        </div>
        
        <div class="payment-body">
            <div class="yassir-logo">
                <img src="img/yass.png" alt="Yassir" class="img-fluid">
            </div>
            
            <div class="yassir-badge">
                <i class="fas fa-info-circle"></i> Le paiement sera confirmé via l'application Yassir
            </div>
            ...
            <form method="POST">
                <div class="mb-3">
                    <label for="numero" class="form-label fw-bold"><i class="fas fa-phone me-2"></i>Numéro Yassir</label>
                    ...
                    <div class="form-text">Entrez votre numéro associé à Yassir (format: 77XXXXXXX)</div>
                </div>
                
                <button type="submit" class="btn btn-yassir mb-3">
    ...
    <script>
        ...
        document.querySelector('.btn-yassir').addEventListener('mouseenter', function() {
            this.querySelector('i').style.transform = 'translateX(5px)';
        });
        document.querySelector('.btn-yassir').addEventListener('mouseleave', function() {
